...
TEXTURE_2D(0, float4, bloomTexture)
TEXTURE_2D(1, float4, sceneTexture)
TEXTURE_2D(2, float4, effectTexture)
TEXTURE_2D(3, float4, fxaaTexture)
TEXTURE_2D(0, float,  bloomMaskTexture)
